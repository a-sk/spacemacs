...
(defun spacemacs//hjkl-completion-navigation ()
  (cond
   ((and (eq dotspacemacs-completion-tool 'helm)
   ...
   ((eq dotspacemacs-completion-tool 'helm)
   ...
   ((and (eq dotspacemacs-completion-tool 'ivy)
         (member dotspacemacs-editing-style '(vim hybrid)))
   ...
   ((eq dotspacemacs-completion-tool 'ivy)
